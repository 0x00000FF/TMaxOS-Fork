...
MSIHANDLE __attribute__((__stdcall__)) __msi_49(MSIHANDLE hInstall) __attribute__((weak, alias("MsiGetActiveDatabase")));
...
UINT __attribute__((__stdcall__)) __msi_103(MSIHANDLE hInstall, INSTALLMESSAGE eMessageType, MSIHANDLE hRecord) __attribute__((weak, alias("MsiProcessMessage")));
...
UINT __attribute__((__stdcall__)) __msi_144(MSIHANDLE hInstall, LPCSTR szName, LPSTR szValue) __attribute__((weak, alias("MsiSetPropertyA")));
...
UINT __attribute__((__stdcall__)) __msi_145(MSIHANDLE hInstall, LPCWSTR szName, LPCWSTR szValue) __attribute__((weak, alias("MsiSetPropertyW")));
...
UINT __attribute__((__stdcall__)) __msi_73(MSIHANDLE hInstall, LPCSTR szName, LPSTR szValueBuf, LPDWORD pcchValueBuf) __attribute__((weak, alias("MsiGetPropertyA")));
...
UINT __attribute__((__stdcall__)) __msi_74(MSIHANDLE hInstall, LPCWSTR szName, LPWSTR szValueBuf, LPDWORD pcchValueBuf) __attribute__((weak, alias("MsiGetPropertyW")));
