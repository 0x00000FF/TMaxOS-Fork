...
UINT __attribute__((__stdcall__)) __msi_45(DWORD iProductIndex, LPWSTR lpProductBuf) __attribute__((weak, alias("MsiEnumProductsW")));
...
UINT __attribute__((__stdcall__)) __msi_37(LPCWSTR szComponent, DWORD index, LPWSTR szProduct) __attribute__((weak, alias("MsiEnumClientsW")));
...
UINT __attribute__((__stdcall__)) __msi_39(LPCWSTR szComponent, DWORD iIndex, LPWSTR lpQualifierBuf, LPDWORD pcchQualifierBuf, LPWSTR lpApplicationDataBuf, LPDWORD pcchApplicationDataBuf) __attribute__((weak, alias("MsiEnumComponentQualifiersW")));
...
UINT __attribute__((__stdcall__)) __msi_180(LPCSTR szProduct, DWORD iPatchIndex, LPSTR lpPatchBuf, LPSTR lpTransformsBuf, LPDWORD pcchTransformsBuf) __attribute__((weak, alias("MsiEnumPatchesA")));
...
UINT __attribute__((__stdcall__)) __msi_181(LPCWSTR szProduct, DWORD iPatchIndex, LPWSTR lpPatchBuf, LPWSTR lpTransformsBuf, LPDWORD pcchTransformsBuf) __attribute__((weak, alias("MsiEnumPatchesW")));
