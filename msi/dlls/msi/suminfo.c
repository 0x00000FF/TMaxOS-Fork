...
UINT __attribute__((__stdcall__)) __msi_78(MSIHANDLE hDatabase, LPWSTR szDatabasePath, UINT uiUpdateCount, MSIHANDLE* phSummaryInfo) __attribute__((weak, alias("MsiGetSummaryInformationW")));
...
UINT __attribute__((__stdcall__)) __msi_77(MSIHANDLE hDatabase, LPCSTR szDatabase, UINT uiUpdateCount, MSIHANDLE* pHandle) __attribute__((weak, alias("MsiGetSummaryInformationA")));
...
UINT __attribute__((__stdcall__)) __msi_148(MSIHANDLE handle, UINT uiProperty, PUINT puiDataType, LPINT piValue, FILETIME* pftValue, LPSTR szValueBuf, LPDWORD pcchValueBuf) __attribute__((weak, alias("MsiSummaryInfoGetPropertyA")));
...
UINT __attribute__((__stdcall__)) __msi_150(MSIHANDLE hSummaryInfo, UINT uiProperty, UINT* puiDataType, INT* piValue, FILETIME* pftValue, LPWSTR szValueBuf, DWORD* pcchValueBuf) __attribute__((weak, alias("MsiSummaryInfoGetPropertyW")));
