...
MSIHANDLE __attribute__((__stdcall__)) __msi_17(UINT cParams) __attribute__((weak, alias("MsiCreateRecord")));
...
UINT __attribute__((__stdcall__)) __msi_115(MSIHANDLE hRecord) __attribute__((weak, alias("MsiRecordGetFieldCount")));
...
int __attribute__((__stdcall__)) __msi_116(MSIHANDLE handle, UINT iField) __attribute__((weak, alias("MsiRecordGetInteger")));
...
UINT __attribute__((__stdcall__)) __msi_121(MSIHANDLE handle, UINT iField, int iVal) __attribute__((weak, alias("MsiRecordSetInteger")));
...
UINT __attribute__((__stdcall__)) __msi_117(MSIHANDLE handle, UINT iField, LPSTR szValue, LPDWORD pcchValue) __attribute__((weak, alias("MsiRecordGetStringA")));
...
UINT __attribute__((__stdcall__)) __msi_118(MSIHANDLE hRecord, unsigned int iField, LPWSTR szValueBuf, DWORD* pcchVlaueBuf) __attribute__((weak, alias("MsiRecordGetStringW")));
...
UINT __attribute__((__stdcall__)) __msi_124(MSIHANDLE handle, UINT iField, LPCSTR szValue) __attribute__((weak, alias("MsiRecordSetStringA")));
...
UINT __attribute__((__stdcall__)) __msi_125(MSIHANDLE handle, UINT iField, LPCWSTR szValue) __attribute__((weak, alias("MsiRecordSetStringW")));
...
UINT __attribute__((__stdcall__)) __msi_120(MSIHANDLE hRecord, UINT iField, char* szDataBuf, LPDWORD pcbDataBuf) __attribute__((weak, alias("MsiRecordReadStream")));
