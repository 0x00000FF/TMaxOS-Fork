...
UINT __attribute__((__stdcall__)) __msi_34(MSIHANDLE hInstall, LPCWSTR szAction) __attribute__((weak, alias("MsiDoActionW")));
...
UINT __attribute__((__stdcall__)) __msi_80(MSIHANDLE hInstall, LPCWSTR szFolder, LPWSTR szPathBuf, LPDWORD pcchPathBuf) __attribute__((weak, alias("MsiGetTargetPathW")));
...
BOOL __attribute__((__stdcall__)) __msi_64(MSIHANDLE hInstall, MSIRUNMODE eRunMode) __attribute__((weak, alias("MsiGetMode")));
...
UINT __attribute__((__stdcall__)) __msi_139(MSIHANDLE hInstall, LPCWSTR szFeature, INSTALLSTATE iState) __attribute__((weak, alias("MsiSetFeatureStateW")));
...
UINT __attribute__((__stdcall__)) __msi_50(MSIHANDLE hInstall, LPCSTR szComponent, INSTALLSTATE* piInstalled, INSTALLSTATE* piAction) __attribute__((weak, alias("MsiGetComponentStateA")));
...
UINT __attribute__((__stdcall__)) __msi_51(MSIHANDLE hInstall, LPCWSTR szComponent, INSTALLSTATE* piInstalled, INSTALLSTATE* piAction) __attribute__((weak, alias("MsiGetComponentStateW")));
...
UINT __attribute__((__stdcall__)) __msi_63(MSIHANDLE hInstall) __attribute__((weak, alias("MsiGetLanguage")));
...
UINT __attribute__((__stdcall__)) __msi_61(MSIHANDLE hInstall, LPCSTR szFeature, LPDWORD lpInstallStates) __attribute__((weak, alias("MsiGetFeatureValidStatesA")));
