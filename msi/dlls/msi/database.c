...
UINT __attribute__((__stdcall__)) __msi_92(LPCWSTR szDatabasePath, LPCWSTR szPersist, MSIHANDLE* phDatabase) __attribute__((weak, alias("MsiOpenDatabaseW")));
...
UINT __attribute__((__stdcall__)) __msi_91(LPCSTR szDatabasePath, LPCSTR szPersist, MSIHANDLE* phDatabase) __attribute__((weak, alias("MsiOpenDatabaseA")));
