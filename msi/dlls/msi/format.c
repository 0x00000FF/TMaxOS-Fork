...
UINT __attribute__((__stdcall__)) __msi_171(MSIHANDLE hInstall, MSIHANDLE hRecord, LPWSTR szResultBuf, LPDWORD pcchResultBuf) __attribute__((weak, alias("MsiFormatRecordW")));
