...
UINT __attribute__((__stdcall__)) __msi_31(MSIHANDLE hDatabase, LPCSTR szQuery, MSIHANDLE* phView) __attribute__((weak, alias("MsiDatabaseOpenViewA")));
...
UINT __attribute__((__stdcall__)) __msi_32(MSIHANDLE hDatabase, LPCWSTR szQuery, MSIHANDLE* phView) __attribute__((weak, alias("MsiDatabaseOpenViewW")));
...
UINT __attribute__((__stdcall__)) __msi_160(MSIHANDLE hView, MSIHANDLE* phRecord) __attribute__((weak, alias("MsiViewFetch")));
...
UINT __attribute__((__stdcall__)) __msi_158(MSIHANDLE hView) __attribute__((weak, alias("MsiViewClose")));
...
UINT __attribute__((__stdcall__)) __msi_159(MSIHANDLE hView, MSIHANDLE hRecord) __attribute__((weak, alias("MsiViewExecute")));
...
UINT __attribute__((__stdcall__)) __msi_166(MSIHANDLE hView, MSICOLINFO eColumnInfo, MSIHANDLE* phRecord) __attribute__((weak, alias("MsiViewGetColumnInfo")));
...
UINT __attribute__((__stdcall__)) __msi_163(MSIHANDLE hView, MSIMODIFY eModifyMode, MSIHANDLE hRecord) __attribute__((weak, alias("MsiViewModify")));
...
MSIHANDLE __attribute__((__stdcall__)) __msi_48() __attribute__((weak, alias("MsiGetLastErrorRecord")));
...
UINT __attribute__((__stdcall__)) __msi_20(MSIHANDLE hDatabase) __attribute__((weak, alias("MsiDatabaseCommit")));
...
UINT __attribute__((__stdcall__)) __msi_26(MSIHANDLE hDatabase, LPCWSTR szTableName, MSIHANDLE* phRecord) __attribute__((weak, alias("MsiDatabaseGetPrimaryKeysW")));
...
MSICONDITION __attribute__((__stdcall__)) __msi_165(MSIHANDLE hDatabase, LPCWSTR szTableName) __attribute__((weak, alias("MsiDatabaseIsTablePersistentW")));
