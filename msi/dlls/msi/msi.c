...
UINT __attribute__((__stdcall__)) __msi_95(LPCSTR szProduct, MSIHANDLE* phProduct) __attribute__((weak, alias("MsiOpenProductA")));
...
UINT __attribute__((__stdcall__)) __msi_88(LPCWSTR szPackagePath, LPCWSTR szCommandLine) __attribute__((weak, alias("MsiInstallProductW")));
...
UINT __attribute__((__stdcall__)) __msi_190(LPCWSTR szProduct, int iInstallLevel, INSTALLSTATE eInstallState, LPCWSTR szCommandLine) __attribute__((weak, alias("MsiConfigureProductExW")));
...
UINT __attribute__((__stdcall__)) __msi_189(LPCSTR szProduct, int iInstallLevel, INSTALLSTATE eInstallState, LPCSTR szCommandLine) __attribute__((weak, alias("MsiConfigureProductExA")));
...
UINT __attribute__((__stdcall__)) __msi_66(LPCWSTR szComponent, LPWSTR szBuffer) __attribute__((weak, alias("MsiGetProductCodeW")));
...
UINT __attribute__((__stdcall__)) __msi_67(LPCSTR szProduct, LPCSTR szAttribute, LPSTR szBuffer, LPDWORD pcchValueBuf) __attribute__((weak, alias("MsiGetProductInfoA")));
...
UINT __attribute__((__stdcall__)) __msi_70(LPWSTR szProduct, LPWSTR szProperty, LPWSTR lpValueBuf, DWORD* pcchValueBuf) __attribute__((weak, alias("MsiGetProductInfoW")));
...
UINT __attribute__((__stdcall__)) __msi_179(LPWSTR patch, LPCWSTR attr, LPWSTR buffer, LPDWORD buflen) __attribute__((weak, alias("MsiGetPatchInfoW")));
...
UINT __attribute__((__stdcall__)) __msi_168(DWORD dwLogMode, LPCSTR szLogFile, DWORD attributes) __attribute__((weak, alias("MsiEnableLogA")));
...
UINT __attribute__((__stdcall__)) __msi_169(DWORD dwLogMode, LPCWSTR szLogFile, DWORD attributes) __attribute__((weak, alias("MsiEnableLogW")));
...
UINT __attribute__((__stdcall__)) __msi_113(LPCWSTR szProduct) __attribute__((weak, alias("MsiQueryProductStateW")));
...
UINT __attribute__((__stdcall__)) __msi_141(INSTALLUILEVEL dwUILevel, HWND* phWnd) __attribute__((weak, alias("MsiSetInternalUI")));
...
UINT __attribute__((__stdcall__)) __msi_136(INSTALLUI_HANDLERA puiHandler, DWORD dwMessageFilter, LPVOID pvContext) __attribute__((weak, alias("MsiSetExternalUIA")));
...
UINT __attribute__((__stdcall__)) __msi_137(INSTALLUI_HANDLERW puiHandler, DWORD dwMessageFilter, LPVOID pvContext) __attribute__((weak, alias("MsiSetExternalUIW")));
...
UINT __attribute__((__stdcall__)) __msi_197(MSIHANDLE handle, UINT id, LPWSTR lpBuffer, int nBufferMax, LANGID lang) __attribute__((weak, alias("MsiLoadStringW")));
...
UINT __attribute__((__stdcall__)) __msi_196(MSIHANDLE handle, UINT id, LPSTR lpBuffer, int nBufferMax, LANGID lang) __attribute__((weak, alias("MsiLoadStringA")));
...
UINT __attribute__((__stdcall__)) __msi_90(LPCWSTR szComponent, LPWSTR lpPathBuf, LPDWORD pcchBuf) __attribute__((weak, alias("MsiLocateComponentW")));
...
UINT __attribute__((__stdcall__)) __msi_279(HWND hWnd, LPCSTR lpText, LPCSTR lpCaption, UINT uType, DWORD unknown, WORD wLanguageId, DWORD f) __attribute__((weak, alias("MsiMessageBoxExA")));
...
UINT __attribute__((__stdcall__)) __msi_280(HWND hWnd, LPCWSTR lpText, LPCWSTR lpCaption, UINT uType, DWORD unknown, WORD wLanguageId, DWORD f) __attribute__((weak, alias("MsiMessageBoxExW")));
...
UINT __attribute__((__stdcall__)) __msi_71(MSIHANDLE hProduct, LPCSTR szProperty, LPSTR szValue, LPDWORD pccbValue) __attribute__((weak, alias("MsiGetProductPropertyA")));
...
INSTALLSTATE __attribute__((__stdcall__)) __msi_173(LPCWSTR szProduct, LPCWSTR szComponent, LPWSTR lpPathBuf, LPDWORD pcchBuf) __attribute__((weak, alias("MsiGetComponentPathW")));
...
UINT __attribute__((__stdcall__)) __msi_111(LPCWSTR szProduct, LPCWSTR szFeature) __attribute__((weak, alias("MsiQueryFeatureStateW")));
...
UINT __attribute__((__stdcall__)) __msi_193(LPCWSTR szProduct, LPCWSTR szFeature, DWORD dwInstallMode, DWORD dwReserved) __attribute__((weak, alias("MsiUseFeatureExW")));
...
UINT __attribute__((__stdcall__)) __msi_155(LPCWSTR szProduct, LPCWSTR szFeature) __attribute__((weak, alias("MsiUseFeatureW")));
...
UINT __attribute__((__stdcall__)) __msi_203(LPCWSTR szComponent, LPCWSTR szQualifier, DWORD dwInstallMode, LPCWSTR szProduct, DWORD Unused1, DWORD Unused2, LPWSTR lpPathBuf, LPDWORD pcchPathBuf) __attribute__((weak, alias("MsiProvideQualifiedComponentExW")));
...
UINT __attribute__((__stdcall__)) __msi_109(LPCWSTR szComponent, LPCWSTR szQualifier, DWORD dwInstallMode, LPWSTR lpPathBuf, LPDWORD pcchPathBuf) __attribute__((weak, alias("MsiProvideQualifiedComponentW")));
...
UINT __attribute__((__stdcall__)) __msi_82(LPCWSTR szProduct, LPWSTR lpUserNameBuf, LPDWORD pcchUserNameBuf, LPWSTR lpOrgNameBuf, LPDWORD pcchOrgNameBuf, LPWSTR lpSerialBuf, LPDWORD pcchSerialBuf) __attribute__((weak, alias("MsiGetUserInfoW")));
...
UINT __attribute__((__stdcall__)) __msi_14(LPCWSTR szProduct, LPCWSTR szFeature, INSTALLSTATE eInstallState) __attribute__((weak, alias("MsiConfigureFeatureW")));
...
UINT __attribute__((__stdcall__)) __msi_129(LPCWSTR szProduct, LPCWSTR szFeature, DWORD dwReinstallMode) __attribute__((weak, alias("MsiReinstallFeatureW")));
...
UINT __attribute__((__stdcall__)) __msi_215(LPCWSTR szProduct, BOOL* pfElevated) __attribute__((weak, alias("MsiIsProductElevatedW")));
