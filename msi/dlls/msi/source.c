...
UINT __attribute__((__stdcall__)) __msi_264(LPCWSTR szProductCordOrPatch, LPCWSTR szUserSid, MSIINSTALLCONTEXT dwContext, DWORD dwOptions, DWORD dwIndex, LPWSTR szSource, LPDWORD pcchSource) __attribute__((weak, alias("MsiSourceListEnumSourcesW")));
...
UINT __attribute__((__stdcall__)) __msi_211(LPCWSTR szProduct, LPCWSTR szUserName, DWORD dwReserved, LPCWSTR szSource) __attribute__((weak, alias("MsiSourceListAddSourceW")));
